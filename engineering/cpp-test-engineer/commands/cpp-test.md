---
name: cpp-test
description: Generate C++ test skeletons, detect frameworks, and summarize coverage. Usage: /cpp-test <detect|generate|coverage> [options]
---

# /cpp-test

Detect C++ test frameworks, generate skeleton suites, and normalize coverage outputs.
