...
**Current Scope:** 239 production-ready skills across 9 domains with 333 Python automation tools, 453 reference guides, 28 agents, and 31 slash commands.
...
├── commands/                  # 31 slash commands (changelog, tdd, saas-health, prd, code-to-prd, plugin-audit, sprint-plan, cpp-pipeline, cpp-test, cpp-review, cpp-design, etc.)
├── engineering-team/          # 37 core engineering skills + Playwright Pro + Self-Improving Agent + Security Suite
├── engineering/               # 49 POWERFUL-tier advanced skills (incl. AgentHub, self-eval, llm-wiki, tc-tracker, and 4 C++ specialist skills)
...
- **C++ specialist suite** — four new POWERFUL-tier engineering skills for build/toolchain detection, test scaffolding, review automation, and architecture planning. Ships 19 stdlib-only Python tools, 18 reference guides, 6 templates, and 4 new slash commands (`/cpp-pipeline`, `/cpp-test`, `/cpp-review`, `/cpp-design`)
- 239 total skills, 333 Python tools, 453 references, 28 agents, 31 commands
...
- Engineering Core (37), Engineering POWERFUL (49), Product (16), Marketing (44), PM (9), C-Level (34), RA/QM (14), Business & Growth (5), Finance (4)
- 333 Python automation tools, 453 reference guides, 28 agents, 31 commands
...
**Version:** v2.3.0
**Status:** 239 skills deployed across 9 domains, 30 marketplace plugins, docs site live
