---
title: "C++ Build and Toolchain — Agent Skill for Codex & OpenClaw"
description: "Use when setting up or auditing C++ build systems, toolchains, CMake projects, compile_commands flows, CI pipelines, or sanitizer build matrices. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-identifier: `cpp-build-and-toolchain`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-build-and-toolchain/SKILL.md">Source</a></span>
</div>
...
- [references/cmake-detection-signals.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-build-and-toolchain/references/cmake-detection-signals.md)
- [references/cpp-ci-matrix-patterns.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-build-and-toolchain/references/cpp-ci-matrix-patterns.md)
- [references/sanitizer-profiles.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-build-and-toolchain/references/sanitizer-profiles.md)
- [references/package-manager-notes.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-build-and-toolchain/references/package-manager-notes.md)
