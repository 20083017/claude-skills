---
title: "C++ Design and Architecture — Agent Skill for Codex & OpenClaw"
description: "Use when designing C++ library boundaries, public header policy, dependency seams, or architecture decision records for reusable systems, SDKs. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-identifier: `cpp-design-and-architecture`</span>
<span class="meta-badge">:material-github: <a href="https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/SKILL.md">Source</a></span>
</div>
...
- [references/cpp-library-architecture.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/references/cpp-library-architecture.md)
- [references/error-model-decision-guide.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/references/error-model-decision-guide.md)
- [references/module-boundary-patterns.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/references/module-boundary-patterns.md)
- [references/public-header-policy.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/references/public-header-policy.md)

## Assets

- [assets/cpp-adr-template.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/assets/cpp-adr-template.md)
- [assets/public-header-policy-template.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/assets/public-header-policy-template.md)
- [assets/package-layout-template.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/cpp-design-and-architecture/assets/package-layout-template.md)
